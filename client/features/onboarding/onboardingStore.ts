...
// returning visitors apart from new ones. See server/lib/ssrOnboarding.ts and
// docs/ssr-hydration.md §6. localStorage remains the source of truth; the
// cookie is a render hint the client reconciles away after mount.
