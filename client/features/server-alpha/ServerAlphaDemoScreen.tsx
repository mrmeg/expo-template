            ...
            {examples.map((example) => (
              ...
              >
                ...
                <View style={styles.patternText}>
                  <SansSerifBoldText size="base" style={styles.patternTitle}>
                    {example.label}
                  </SansSerifBoldText>
                  <SansSerifText size="sm" style={styles.patternDescription}>
                    {example.pattern}
                  </SansSerifText>
                </View>
              </Pressable>
          ...
          <CardContent style={styles.rows}>
            ...
            <View style={styles.apiActions}>
              ...
              >
                ...
                <SansSerifText size="sm" style={styles.actionText}>
