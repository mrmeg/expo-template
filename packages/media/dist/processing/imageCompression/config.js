...
function normalizeRungs(rungs, fallback) {
...
export function resolveCompressionConfig(options) {
    ...
    return {
        ...
        passthroughBytes: normalizeBytes(options.passthroughBytes ?? defaults.passthroughBytes, defaults.passthroughBytes),
