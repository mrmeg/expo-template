...
export { CANVAS_LIMIT_CHROMIUM, CANVAS_LIMIT_DEFAULT, CANVAS_LIMIT_FIREFOX, CANVAS_LIMIT_IOS, DEFAULT_PRESET as DEFAULT_IMAGE_PRESET, IMAGE_PRESETS, calculateDimensions, canvasLongEdgeLimitFor, clampLongEdgeToCanvasLimit, compressImage, compressImageWith, convertHeicToJpeg, convertHeicToJpegIfNeeded, displayDimensions, formatFileSize, hasHeicExtension, imagePlatformAdapter, isHeicBlob, longEdgeOf, resolveCompressionConfig, resolveLadderRungs, runDimensionLadder, type CompressedImage, type CompressImageOptions, type CompressionConfig, type DisposeEncodedImage, type EncodedImage, type EncodeImage, type EncodeImageOptions, type ImagePreset, type ImageSource, } from "./imageCompression";
